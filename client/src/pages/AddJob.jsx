...
const AddJob = () => {
  ...
  return (
    <form className="container flex flex-col w-full items-start gap-3 mt-2 ml-2">
    ...
    <div>
      ...
      <input min={0} className="w-full max-w-lg px-3 py-2 border-2 border-gray-300 rounded outline-none sm:[w-120px] " onChange={e => setSalary(e.target.value)} type="Number" placeholder="2500" />
    </div>
    <button className="w-28 mt-4 px-1.5 py-2 rounded bg-black text-white cursor-pointer">ADD</button>
    </form>
  );
};
