...
const JobCard = ({job}) => {
  ...
  return (
    <div className=" border border-gray-100  p-6 shadow-lg rounded">
      ...
      <p dangerouslySetInnerHTML={{__html:job.description.slice(0,150)}} className="text-gray-400 text-sm mt-4"></p>
      <div className="mt-4 flex gap-4 text-sm">
        <button onClick={() => {navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className="bg-blue-600 hover:bg-blue-500 cursor-pointer text-white px-4 py-2 rounded">Apply Now</button>
